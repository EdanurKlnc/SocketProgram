	...
	private static ServerSocket serverSocket; 
	   ...
	   {  
	      ...
	      {  
	    	  ...
	    	  serverSocket = new ServerSocket(router3PORT);  //yazýlan porttaki bu server üzerindeki tüm serversocketleri görsün
	         link2 = new Socket(host,router2PORT); //gelen baðlantýyý yazar
