...
public class TcpRouter4 {
	...
	private static ServerSocket serverSocket; 
	   ...
	   private static final int router4PORT = 1244; 
	   private static final int router3PORT = 1243;
	   ...
	   {  
	      ...
	      {  
	    	  ...
	    	  serverSocket = new ServerSocket(router4PORT);  //yazýlan porttaki bu server üzerindeki tüm serversocketleri görsün
	         link2 = new Socket(host,router3PORT); //gelen baðlantýyý yazar
